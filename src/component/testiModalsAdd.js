                    ...
                    <motion.div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <motion.div className="relative p-6 flex-auto">
                            <form className="w-96">
                                ...
                                <div>
                                    <label className="block  ">Select Rate</label>
                                    <select className="mb-3 border border-gray-300 text-sm rounded-xl focus:ring-blue-500 focus:border-gray-400 block w-full p-2.5">
                                        <option>1/5</option>
                                        <option>2/5</option>
                                        <option>3/5</option>
                                        <option>4/5</option>
