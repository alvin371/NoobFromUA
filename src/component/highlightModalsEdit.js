...
const ListModalEdit = ({ open, id, title_id, title_en, description_id, description_en, image, onClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (itemImage === '') {
            ...
            const editData = axios.patch(`https://staging.javaagroglobalindo.com/highlights/edit/${id}`, value, {
                ...
                .then((data) => {
                    ...
                    if (data.data.message === 'Success') {
                        swal({
                            title: "Success!",
                            text: "Highlights berhasil di Edit!",
                            icon: "success",
                            timer: 3000
                        });
                        onClose()
                            ...
                            <form className="w-96">
                                <div className="mb-3 grid grid-cols-1">
                                    ...
                                    <input
                                        ...
                                        defaultValue={title_id}
                                    />
                                    <label >Slider Title in EN</label>
                                    <input
                                        type="text"
                                        name="title_en"
                                        className="mt-2 w-64 md:w-full px-4 py-2 rounded-xl border border-gray-300 outline-none  focus:border-gray-400"
                                ...
                                <div className="mb-3 grid grid-cols-1">
                                    ...
                                    <textarea
                                        className="mt-2 w-64 md:w-full px-4 py-2 rounded-xl border border-gray-300 outline-none   focus:border-gray-400" defaultValue={description_id} onChange={e => { setDescId(e.target.value) }}></textarea>
                                    <label>Description in EN</label>
                                    <textarea
                                        className="mt-2 w-64 md:w-full px-4 py-2 rounded-xl border border-gray-300 outline-none  focus:border-gray-400" defaultValue={description_en} onChange={e => { setDescEn(e.target.value) }}></textarea>
                                </div>
                                <div className="mb-3">
